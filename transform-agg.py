...
# Drop unused columns
customer_store_df = customer_store_df[['customer_id', 'first_name', 'last_name', 'store_id']]

# Group
customer_count_by_store = customer_store_df.groupby(['store_id'])['customer_id'].count()

# Print result to terminal
print(customer_count_by_store)
